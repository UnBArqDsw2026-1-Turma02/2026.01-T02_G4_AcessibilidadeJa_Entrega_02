...
| `1.3`  | 21/04/2026 | Criação INICIAL do diagrama de casos de uso | [Fernanda Vaz](https://github.com/) |
| `1.4`  | 23/04/2026 | Versão com melhorias do diagrama de casos de uso| [Fábio Araújo](https://github.com/fabiofonteles1) |
| `1.5`  | 23/04/2026 | Descrição detalhada dos pacotes (subpacotes, relações e síntese arquitetural) | [Matheus Rodrigues](https://github.com/mrodrigues14) |